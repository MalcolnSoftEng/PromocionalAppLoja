...
public class CapaHttp {
    public static final String BASE_URL = "http://xxxxxxxxxxxxxxxxx";


    public static CapaModel[] obterNovidadesDoServidor(){
        ...
        try {
            ...
            Gson gson = new Gson();
            return gson.fromJson(json,CapaModel[].class);
        } catch (Exception e){
            e.printStackTrace();
        }
