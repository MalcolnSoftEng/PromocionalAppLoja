...
public class PromocoesHttp {
    public static final String BASE_URL = "xxxxxxxxxxxxxxxxxxxxxxxxxx";


    public static PromocoesItem[] obterNovidadesDoServidor(){
        ...
        try {
            ...
            Gson gson = new Gson();
            return gson.fromJson(json,PromocoesItem[].class);
        } catch (Exception e){
            e.printStackTrace();
        }
